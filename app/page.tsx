...
export default function Home() {
  return (
    <div className="main w-full lg:pt-[100px] lg:p-[60px] md:pt-[90px] md:p-[40px] pt-[80px] p-[20px] bg-sySky">
      <div className="flex flex-wrap items-center text-syNavy uppercase font-medium lg:text-[110px] md:text-[60px] text-[40px] break-all leading-normal tracking-tighter">
        welcome to
